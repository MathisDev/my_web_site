...
function resize1(){
    ...
    aa.onclick = function() {
        ...
        classBtnDevis.style.transition = "1s";
        btnDevis.style.transition ="1s";

        classBtnDevis.style.backgroundColor ="white";
        btnDevis.style.color ="white";
        bando.style.backgroundColor ="white";
        ...
        aa.onclick = function() {
            ...
            classBtnDevis.style.backgroundColor ="black";
            btnDevis.style.color ="black";
