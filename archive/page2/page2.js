...
function resize1(){
    ...
    aa.onclick = function() {
        ...
        bando.style.backgroundColor ="#f097aa";
        a1.style.backgroundColor = "#f097aa";
        b2.style.backgroundColor = "#f097aa";
        c3.style.backgroundColor = "#f097aa";
        d4.style.backgroundColor = "#f097aa";
        aa.style.backgroundColor = "#f097aa";
